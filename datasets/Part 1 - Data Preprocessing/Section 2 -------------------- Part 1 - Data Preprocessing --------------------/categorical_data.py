...
# actualicación 3.7 Para codificar datos categóricos y algunas transformaciones adicionales que aprenderéis en las próximas clases, en caso de que utilicéis la última versión de Python, veréis que ha cambiado un poco la librería y su sintaxis.
